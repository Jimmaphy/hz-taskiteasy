<x-layout.main title="About">
    <x-general.contentblock>
        <x-general.title>About</x-general.title>

        <x-general.textWithTitle title="Welcome to Our App">
        ...
        <x-general.textWithTitle title="Key Features">
        ...
        <x-general.textWithTitle title="Our Vision">
